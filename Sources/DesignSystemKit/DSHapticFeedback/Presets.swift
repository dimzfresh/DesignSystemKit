...
public extension HapticFeedback {
    ...
    static var start: HapticFeedback {
        HapticFeedback(label: "SwiftUI_Haptics_TYPE_START") {
            #if os(watchOS)
    ...
    ///
    /// Only plays feedback on watchOS.
    static var stop: HapticFeedback {
        HapticFeedback(label: "SwiftUI_Haptics_TYPE_STOP") {
            #if os(watchOS)
...
public extension HapticFeedback {
    ...
    static var alignment: HapticFeedback {
        HapticFeedback(label: "SwiftUI_Haptics_TYPE_ALIGNMENT") {
            #if os(macOS)
    ...
    ///
    /// Only plays feedback on watchOS.
    static var decrease: HapticFeedback {
        HapticFeedback(label: "SwiftUI_Haptics_TYPE_DECREASE") {
            #if os(watchOS)
    ...
    ///
    /// Only plays feedback on watchOS.
    static var increase: HapticFeedback {
        HapticFeedback(label: "SwiftUI_Haptics_TYPE_INCREASE") {
            #if os(watchOS)
    ...
    /// playback could increase or decrease
    /// and haptic feedback could be provided as different levels of pressure are reached.
    ///
    /// Only plays feedback on macOS.
    static var levelChange: HapticFeedback {
        HapticFeedback(label: "SwiftUI_Haptics_TYPE_LEVELCHANGE") {
            #if os(macOS)
            NSHapticFeedbackManager.defaultPerformer
    ...
    static var selection: HapticFeedback {
        HapticFeedback(label: "SwiftUI_Haptics_TYPE_SELECTION") {
            #if os(iOS)
...
public extension HapticFeedback {
    ...
    ///
    /// Only plays feedback on iOS and watchOS.
    static var success: HapticFeedback {
        HapticFeedback(label: "SwiftUI_Haptics_TYPE_SUCCESS") {
            #if os(iOS)
    ...
    /// Only plays feedback on iOS and watchOS.
    static var warning: HapticFeedback {
        HapticFeedback(label: "SwiftUI_Haptics_TYPE_WARNING") {
            #if os(iOS)
            let generator = UINotificationFeedbackGenerator()
            generator.prepare()
    ...
    ///
    /// Only plays feedback on iOS and watchOS.
    static var error: HapticFeedback {
        HapticFeedback(label: "SwiftUI_Haptics_TYPE_ERROR") {
            #if os(iOS)
            let generator = UINotificationFeedbackGenerator()
            generator.prepare()
...
public extension HapticFeedback {
    ...
    ///
    /// Use this to provide feedback for UI elements colliding.
    ///  It should supplement the user experience, since only some platforms will play feedback in response to it.
    ///
    /// Only plays feedback on iOS and watchOS.
    static var impact: HapticFeedback {
        HapticFeedback(label: "SwiftUI_Haptics_TYPE_IMPACT") {
            #if os(iOS)
    ...
    /// Provides a physical metaphor you can use to complement a visual experience.
    ///
    /// Use this to provide feedback for UI elements colliding. It should supplement the user experience, 
    /// since only some platforms will play feedback in response to it.
    ///
    ...
    static func impact(
        ...
        HapticFeedback(label: "SwiftUI_Haptics_TYPE_IMPACT_\(weight.rawValue)_\(intensity)") {
            #if os(iOS)
    ...
    static func impact(
        ...
        HapticFeedback(label: "SwiftUI_Haptics_TYPE_IMPACT_\(flexibility.rawValue)_\(intensity)") {
            #if os(iOS)
